const BINARY_PREFIX = "RestPie.Core";
...
const config = {
  ...
  squirrelWindows: {
    artifactName: `${BINARY_PREFIX}-\${version}.\${ext}`,
    iconUrl:
      "https://github.com/archGPT/restpie/blob/main/packages/restpie/src/icons/icon.png?raw=true",
  },
  portable: {
  ...
  linux: {
    artifactName: `${BINARY_PREFIX}-\${version}.\${ext}`,
    icon: "src/icons",
    executableName: "restpie",
    synopsis: "The Collaborative API Client and Design Tool",
    category: "Development",
    desktop: {
      Name: "RestPie",
      Comment:
        "RestPie is a cross-platform REST client, built on top of Electron.",

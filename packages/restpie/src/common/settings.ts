...
export interface Settings {
  ...
  /** If true, RestPie won’t show a notification when new updates are available. Users can still check for updates in Preferences. */
  ...
  /** If true, RestPie will send anonymous data about features and plugins used. */

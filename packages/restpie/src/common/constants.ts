...
export const getAppEnvironment = () => process.env.RESTPIE_ENV || 'production';
 ...
 *
 * For initial introduction, see https://github.com/ArchGPT/restpie/blob/8aa274d21b351c4710f0bb833cba7deea3d56c29/app/ui/components/ResponsePane.js#L100
*/
...
// Hotkey
// For an explanation of mnemonics on linux and windows see https://github.com/ArchGPT/restpie/pull/1221#issuecomment-443543435 & https://docs.microsoft.com/en-us/cpp/windows/defining-mnemonics-access-keys?view=msvc-160#mnemonics-access-keys
...
export enum UpdateURL {
  mac = 'https://archgpt.dev/restpie/builds/check/mac',
  windows = 'https://archgpt.dev/restpie/updates/win',
}

// API
export const getApiBaseURL = () => env.RESTPIE_API_URL || 'https://api.restpie.dev';

export const getUpdatesBaseURL = () => env.RESTPIE_UPDATES_URL || 'https://archgpt.dev/restpie';

// App website
export const getAppWebsiteBaseURL = () => env.RESTPIE_APP_WEBSITE_URL || 'https://app.restpie.dev';

// GitHub API
export const getGitHubGraphQLApiURL = () => env.RESTPIE_GITHUB_API_URL || 'https://api.github.com/graphql';

// License
export const getLicenseURL = () => env.RESTPIE_LICENSE_URL || 'https://github.com/ArchGPT/restpie/blob/main/LICENSE';
...
export const RESPONSE_CODE_DESCRIPTIONS: Record<number, string> = {
  ...
  [STATUS_CODE_PLUGIN_ERROR]:
    'A RestPie plugin threw an error which prevented the request from sending',
  // 100s

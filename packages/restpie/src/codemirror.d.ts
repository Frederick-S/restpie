...
declare module 'codemirror' {
  ...
  interface Hint {
    /**
     * Custom RestPie Key. Used for checking the type of the hint
     */
    type: 'constant' | 'variable' | 'snippet' | 'tag';
    /**
     * Custom RestPie Key. The segment that matched and produced this hint
     */
    segment: string;
    /**
     * Custom RestPie Key. This value gets displayed in the autocomplete menu.
     */
    displayValue: string;
    /**
     * Custom RestPie Key. The display value of the hint
     */
    comment?: string;
    /**
     * Custom RestPie Key. Used for sorting the hints
     */
    score: number;
    /**
     * Custom RestPie Key. Used for snippet promises
     */

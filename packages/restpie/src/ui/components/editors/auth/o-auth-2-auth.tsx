...
const getFields = (authentication: Request['authentication']) => {
  ...
  const redirectUri = <AuthInputRow label='Redirect URL' property='redirectUrl' key='redirectUrl' help='This can be whatever you want or need it to be. RestPie will automatically detect a redirect in the client browser window and extract the code from the redirected URL.' />;

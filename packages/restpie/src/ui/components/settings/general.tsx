    ...
    <div className="pad-bottom">
      ...
      <div className="form-row pad-top-sm">
        <BooleanSetting
          ...
          help="If checked, clears the OAuth session every time RestPie is relaunched."
        />
        <button
      ...
      <BooleanSetting
        ...
        help="If checked, enables a global network proxy on all requests sent through RestPie. This proxy supports Basic Auth, digest, and NTLM authentication."
      />

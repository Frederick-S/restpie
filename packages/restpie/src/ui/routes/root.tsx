...
const Root = () => {
    ...
    return window.main.on(
      ...
      async (_: IpcRendererEvent, url: string) => {
        ...
        try {
          ...
          console.log('Invalid args, expected restpie://x/y/z', url);
          return;
        }
        ...
        switch (urlWithoutParams) {
          ...
          case 'restpie://app/import':
            setImportUri(params.uri);
            break;

          case 'restpie://plugins/install':
            showModal(AskModal, {
          ...
          case 'restpie://oauth/github/authenticate': {
          ...
          case 'restpie://oauth/gitlab/authenticate': {
            const { code, state } = params;
  ...
  return (
      <NunjucksEnabledProvider>
        ...
        <div className="app">
          <Modals />
          {/* triggered by restpie://app/import */}
          {importUri && (
            <ImportModal
              onHide={() => setImportUri('')}
              projectName="RestPie"
